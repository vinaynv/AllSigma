...
<% 
   ...
   try {
   String connectionURL = "jdbc:mysql://enst01db02pr.aesenergystorage.com:3306/hibernate?user=nagraj.r&password=Sigma_2011!";
...
((org.springframework.security.providers.UsernamePasswordAuthenticationToken)obj).getPrincipal();
   ...
   String QueryString = "INSERT INTO APPLICATIONS (pentaho_user,monitoring_user,monitoring_pass) VALUES ('" + user1.getUsername() + "','" + user + "','" + encryptedPassword2 + "')";
   String QueryString2 = "UPDATE APPLICATIONS set monitoring_user='" + user + "',monitoring_pass='" + encryptedPassword2 + "' where pentaho_user='" + user1.getUsername() +"'";
...
alert('Succesfully updated the ' + '<%=user%>' +' credentials for monitoring application');
