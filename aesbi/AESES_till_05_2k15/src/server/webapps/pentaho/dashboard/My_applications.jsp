...
var SCADApf = document.getElementById( 'SCADAForm' );
var Monitoringpf = document.getElementById( 'MonitoringForm' );
pf.style.display = 'block';
BCpf.style.display = 'none';
SCADApf.style.display = 'none';
Monitoringpf.style.display = 'none';
...
document.getElementById( 'SCADA' ).style.background="none";
document.getElementById( 'Monitoring' ).style.background="none";
}
...
pf.style.display = 'none';
BCpf.style.display = 'none';
SCADApf.style.display='block';
Monitoringpf.style.display = 'none';
document.getElementById( 'JIRA' ).style.background="none";
document.getElementById( 'BC' ).style.background="none";
document.getElementById( 'SCADA' ).style.background="none repeat scroll 0 0 #B1C8AE";
document.getElementById( 'Monitoring' ).style.background="none";
}
...
BCpf.style.display = 'none';
SCADApf.style.display = 'none';
Monitoringpf.style.display = 'block';
document.getElementById( 'JIRA' ).style.background="none";
document.getElementById( 'BC' ).style.background="none";
document.getElementById( 'SCADA' ).style.background="none";
document.getElementById( 'Monitoring' ).style.background="none repeat scroll 0 0 #B1C8AE";
}
...
function getSCADAdata( arg ) {
var f = document.getElementById( 'SCADAForm' );
if ( 'Cancel' == arg ) {
f.style.display = 'none'; // hide form
return; // exit immediately
}
...
function getMonitoringdata( arg ) {
var f = document.getElementById( 'MonitoringForm' );
if ( 'Cancel' == arg ) {
f.style.display = 'none'; // hide form
return; // exit immediately
}
...
<body>
	...
	<div id="sidebar">			
				...
				<li><a href="#"  onclick="promptSCADA()" id="SCADA">SCADA</a></li>		
                            <li><a href="#"  onclick="promptMonitoring()" id="Monitoring">Monitoring</a></li>		
				</ul>		
	</div>
		...
		<input type="button" value="Cancel" onclick="getBCPdata( this.value )" />	
              ...
              <form action="My_application_SCADA.jsp" method="post" id="SCADAForm" onsubmit="return validateForm3()" style="display: none;   float: right; margin: 0 10px 10px -4px; width: 74%;">
		Enter your credentials for SCADA application<br><br>
		User name: <input type="text" name="name" style="margin: 0pt 0pt 0pt 14px;"/><br><br>
		Password:  <input type="password" name="pass" style="margin: 0pt 0pt 0pt 20px;"/><br><br>
		<input type="submit" value="Save" onclick="getSCADAdata()" style="margin: 0pt 0pt 0pt 75px;"/>
		<input type="reset" value="Reset" onclick="this.form.reset()" />
		<input type="button" value="Cancel" onclick="getSCADAdata( this.value )" />
	       </form>

              <form action="My_application_Monitoring.jsp" method="post" id="MonitoringForm" onsubmit="return validateForm4()" style="display: none;   float: right; margin: 0 10px 10px -4px; width: 74%;">
		Enter your credentials for Monitoring application<br><br>
		User name: <input type="text" name="name" style="margin: 0pt 0pt 0pt 14px;"/><br><br>
		Password:  <input type="password" name="pass" style="margin: 0pt 0pt 0pt 20px;"/><br><br>
		<input type="submit" value="Save" onclick="getMonitoringdata()" style="margin: 0pt 0pt 0pt 75px;"/>
		<input type="reset" value="Reset" onclick="this.form.reset()" />
		<input type="button" value="Cancel" onclick="getMonitoringdata( this.value )" />	
              </form>
