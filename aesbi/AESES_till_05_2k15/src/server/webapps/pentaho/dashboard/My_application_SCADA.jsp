...
((org.springframework.security.providers.UsernamePasswordAuthenticationToken)obj).getPrincipal();
   ...
   String QueryString = "INSERT INTO APPLICATIONS (pentaho_user,scada_user,scada_pass) VALUES ('" + user1.getUsername() + "','" + user + "','" + encryptedPassword2 + "')";
   String QueryString2 = "UPDATE APPLICATIONS set scada_user='" + user + "',scada_pass='" + encryptedPassword2 + "' where pentaho_user='" + user1.getUsername() +"'";
...
alert('Succesfully updated the ' + '<%=user%>' +' credentials for SCADA application');
